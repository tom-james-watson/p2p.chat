...
export default function TermsAndConditions() {
  return (
    <Container>
      ...
      <LegalSubHeader title="OVERVIEW" />

      <LegalParagraph>
        This website is operated by p2p.chat. Throughout the site, the terms
        “we”, “us” and “our” refer to p2p.chat. p2p.chat offers this website,
      ...
      <LegalSubHeader title="SECTION 1 - GENERAL TERMS" />
      ...
      <LegalSubHeader title="SECTION 2 - GENERAL CONDITIONS" />
      ...
      <LegalSubHeader title="SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION" />
      ...
      <LegalSubHeader title="SECTION 4 - MODIFICATIONS TO THE SERVICE" />
      ...
      <LegalSubHeader title="SECTION 5 - OPTIONAL TOOLS" />
      ...
      <LegalSubHeader title="SECTION 6 - THIRD-PARTY LINKS" />
      ...
      <LegalSubHeader title="SECTION 7 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS" />
      ...
      <LegalParagraph>
        ...
        comments.We may, but have no obligation to, monitor, edit or remove
        ...
        these Terms of Service.You agree that your comments will not violate any
      ...
      <LegalSubHeader title="SECTION 8 - PERSONAL INFORMATION" />

      <LegalParagraph>
        Your submission of personal information through the store is governed by
        our Privacy Policy. To view our Privacy Policy, visit
        https://p2p.chat/privacy-policy.
      </LegalParagraph>

      <LegalSubHeader title="SECTION 9 - ERRORS, INACCURACIES AND OMISSIONS" />
      ...
      <LegalParagraph>
        ...
        update information if any information in the Service or on any related
      ...
      <LegalSubHeader title="SECTION 10 - PROHIBITED USES" />
      ...
      <LegalSubHeader title="SECTION 11 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY" />
      ...
      <LegalParagraph>
        ...
        shall p2p.chat, our directors, officers, employees, affiliates, agents,
      ...
      <LegalSubHeader title="SECTION 12 - INDEMNIFICATION" />

      <LegalParagraph>
        You agree to indemnify, defend and hold harmless p2p.chat and our
      ...
      <LegalSubHeader title="SECTION 13 - SEVERABILITY" />
      ...
      <LegalSubHeader title="SECTION 14 - TERMINATION" />
      ...
      <LegalSubHeader title="SECTION 15 - ENTIRE AGREEMENT" />
      ...
      <LegalSubHeader title="SECTION 16 - GOVERNING LAW" />
      ...
      <LegalSubHeader title="SECTION 17 - CHANGES TO TERMS OF SERVICE" />
      ...
      <LegalSubHeader title="SECTION 18 - CONTACT INFORMATION" />
